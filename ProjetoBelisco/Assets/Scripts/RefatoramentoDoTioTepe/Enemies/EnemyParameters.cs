...
namespace RefatoramentoDoTioTepe
{
    ...
    public class EnemyParameters : ScriptableObject
    {
        ...
        [BoxGroup("Movement/WallDetection")][SerializeField] protected Vector2 wallCheckerCenter = Vector3.zero;
        ...
        [BoxGroup("Targeting")][SerializeField] private Vector2 targetingCenter;
        [BoxGroup("Targeting/Boss")][SerializeField] private Vector2 bossZoneCornerA;
        [BoxGroup("Targeting/Boss")][SerializeField] private Vector2 bossZoneCornerB;
